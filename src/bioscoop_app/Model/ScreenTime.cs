...
namespace bioscoop_app.Model
{
	public class ScreenTime : DataType
	{
		...
		public ScreenTime(Movie movie, DateTime startTime, DateTime endTime, Room room, List<List<bool>> availability)
		{
			this.movie = movie;
		...
		[JsonConstructor]
		public ScreenTime(int id, Movie movie, DateTime startTime, DateTime endTime, Room room, List<List<bool>> availability)
		{
			this.id = id;
			this.movie = movie;
			this.startTime = startTime;
